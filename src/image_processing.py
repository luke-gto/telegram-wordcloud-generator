...
def make_mask(
    image,
):  # converts a png supposedly ready to be used as a mask to a np array
...
def black_and_white(
    img_path,
):  # converts a random PNG to a grayscale img and then to a b/w image then it becomes an array ready to be used as a mask

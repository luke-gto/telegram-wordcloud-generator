...
def main():
    ...
    if choice == "3":
        print("Loading...\n")
        easygui.msgbox(
            "Select the folder where you want to save the chat messages ready for some text mining with third party tools",
            "Telegram chat wordcloud generator",
        )
        save_directory = easygui.diropenbox(
            msg="Select the folder", default=script_directory
        )
